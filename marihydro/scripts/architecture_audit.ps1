...
try {
    ...
    Invoke-InformationalScan -Name "hydraulic preset residue" -Roots @("crates/mh_physics") -Pattern "\bJonswap\b|\bjonswap\(|\bFlexible\b|\breed\(\)|\bmangrove\(\)|with_reed_zone|with_mangrove_zone|update_from_radiation_stress|compute_effective_shear\(|compute_gradient_simple"
