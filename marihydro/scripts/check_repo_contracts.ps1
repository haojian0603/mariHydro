...
try {
    ...
    $requiredFiles = @(
        ...
        "scripts/check_driver_metadata_contracts.ps1",
        "scripts/check_external_driver_access_contracts.ps1",
        "scripts/check_vtu_export_contracts.ps1",
        ...
        "scripts/check_io_snapshot_contracts.ps1",
        "scripts/check_pipeline_shutdown_contracts.ps1",
        "scripts/check_geo_geodesic_contracts.ps1",
        "scripts/check_geo_vector_contracts.ps1",
        "scripts/check_geo_central_meridian_contracts.ps1",
        "scripts/check_geo_ellipsoid_epsg_contracts.ps1",
        "scripts/check_geo_affine_contracts.ps1",
        "scripts/check_geo_crs_contracts.ps1",
        "scripts/check_geo_auto_projection_contracts.ps1",
        "scripts/check_geo_projection_contracts.ps1",
        "scripts/check_spatial_index_contracts.ps1",
        "scripts/check_mesh_spatial_contracts.ps1",
        "scripts/check_mesh_structured_contracts.ps1",
        "scripts/check_mhb_contracts.ps1",
        "scripts/check_gmsh_contracts.ps1",
    ...
    if (Test-Path $agentsPath) {
        ...
        $requiredClauses = @(
            ...
            "[RULE_TIDE_GRID_INTERPOLATION_EXPLICIT]",
            ...
            "[RULE_IO_SNAPSHOT_STATISTICS_EXPLICIT]",
            ...
            "[RULE_EXTERNAL_DRIVER_INDEX_ACCESS_EXPLICIT]",
            "[RULE_DRIVER_METADATA_TRUTHFUL]",
            "[RULE_EXPORT_STATE_ACCESS_EXPLICIT]",
            "[RULE_EXPORT_STATE_SHAPE_EXPLICIT]",
            "[RULE_GEO_PROJECTION_ERRORS_EXPLICIT]",
            "[RULE_GEO_ELLIPSOID_DETECTION_EXPLICIT]",
            ...
            "[RULE_GEO_AUTO_ZONE_SINGLE_SOURCE_OF_TRUTH]",
            "[RULE_SPATIAL_RADIUS_QUERY_EXACT]",
            "[RULE_MESH_CIRCLE_QUERY_EXACT]",
            "[RULE_STRUCTURED_BED_ELEVATION_EXPLICIT]",
            "[RULE_MHB_BINARY_FIELDS_EXPLICIT]",
            "[RULE_GMSH_PARSE_EXPLICIT]",
            "[RULE_GEO_GEODESIC_FAILURES_EXPLICIT]",
            "[RULE_GEO_VECTOR_NORMALIZATION_EXPLICIT]",
            "[RULE_GEO_CENTRAL_MERIDIAN_EXPLICIT]",
            "[RULE_GEO_ELLIPSOID_EPSG_EXPLICIT]",
            ...
            "[RULE_SETTLING_FORMULA_INPUTS_COMPLETE]",
            "[RULE_DIFFUSION_TENSOR_PROJECTION_EXACT]",
