...
try {
    ...
    Invoke-Step -Name "external data contracts (layout truth + matched-layout validation + tide interpolation semantics + CLI tool context)" -Action {
    ...
    Invoke-Step -Name "geo vector contracts" -Action {
    ...
    Invoke-Step -Name "geo ellipsoid EPSG contracts" -Action {
    ...
    Invoke-Step -Name "geo auto projection contracts (domain + antimeridian + single-source zone semantics)" -Action {
