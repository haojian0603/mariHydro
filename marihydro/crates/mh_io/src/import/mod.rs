...
// IO_SCOPE: The public import entrypoint only re-exports readers whose failure semantics stay explicit. Unsupported or structurally invalid inputs must fail instead of synthesizing geometry, metadata, default payloads, or semantic names for boundary and zone features.
